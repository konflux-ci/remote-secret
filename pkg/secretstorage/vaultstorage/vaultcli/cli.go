...
type VaultCliArgs struct {
	...
	VaultAppRoleSecretName         string                       `arg:"--vault-approle-secret-name, env"  help:"Secret name in k8s namespace with approle credentials. Used with Vault approle authentication. Secret should contain 'role_id' and 'secret_id' keys."`
	VaultAppRoleSecretNamespace    string                       `arg:"--vault-approle-secret-namespace, env" help:"Secret name in k8s namespace with approle credentials. Used with Vault approle authentication. Secret should contain 'role_id' and 'secret_id' keys."`
